	...
	},
	{
		...
		config = function()
			require("mason-lspconfig").setup({
				ensure_installed = { "lua_ls", "ts_ls", "html", "cssls", "tailwindcss", "emmet_ls", "jsonls", "intelephense" },
			})
		end,
	},
	{
		...
		config = function()
			...
			local servers = { "lua_ls", "ts_ls", "html", "cssls", "tailwindcss", "emmet_ls", "jsonls", "intelephense" }
